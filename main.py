...
def Plot_Gaussian_Result(PCA_data, target, mean_accuracy, GNB_model, parsing_targets, parsing_groups, i, ii):
    ...
    amber_patch = mpatches.Patch(color=sns.xkcd_rgb["light red"], label='Control learning Condition')
    blue_patch = mpatches.Patch(color=sns.xkcd_rgb["charcoal"], label='Control Non-Learning Condition')
